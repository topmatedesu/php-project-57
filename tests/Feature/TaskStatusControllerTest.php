...
class TaskStatusControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->taskStatus = TaskStatus::factory()->create(['name' => 'выполняется']);
    }
    ...
    {
        $this->actingAs($this->user);
        $body = TaskStatus::factory()->make(['name' => 'в архиве'])->only('name');
    ...
    {
        $this->actingAs($this->user);
        $body = TaskStatus::factory()->make(['name' => 'завершена'])->only('name');
