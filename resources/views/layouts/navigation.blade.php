<div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
    ...
    <div class="items-center justify-between w-full lg:flex lg:w-auto lg:order-1">
        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            <li>
                <a href="{{ url('/tasks') }}" class="block py-2 pl-3 pr-4 text-gray-700 hover:text-blue-700 lg:p-0">{{ __('Tasks') }}</a>
            </li>
            <li>
                <a href="{{ url('/task_statuses') }}" class="block py-2 pl-3 pr-4 text-gray-700 hover:text-blue-700 lg:p-0">{{ __('Statuses') }}</a>
            </li>
            <li>
                <a href="{{ url('/labels') }}" class="block py-2 pl-3 pr-4 text-gray-700 hover:text-blue-700 lg:p-0">{{ __('Labels') }}</a>
            </li>
        </ul>
    </div>
</div>
